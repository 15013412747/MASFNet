...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        use_wandb = wandb and 'wandb' in self.include
        import sys
        ...
        if use_wandb:  # 不使用 wandb by limeng 2022.11.21
...
class GenericLogger:
    ...
    def __init__(self, opt, console_logger, include=('tb', 'wandb')):
        ...
        if wandb and 'wandb' in self.include:
            # print("project==>",(str(opt.project)))
            # print("project==>",web_project_name(str(opt.project)))
            project_name = web_project_name(str(opt.project))
            project_name = "YOLOv5"
            self.wandb = wandb.init(project=project_name,
                                    name=None if opt.name == "run-20230924_162645-c9elreke_VOC_yolov5s_0.753" else opt.name,
                                    config=opt)
        else:
            self.wandb = None

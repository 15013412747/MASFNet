...
def increment_path(path, exist_ok=False, sep='', mkdir=False):
    # Increment file or directory path, i.e. runs/run-20230924_162645-c9elreke_VOC_yolov5s_0.753 --> runs/run-20230924_162645-c9elreke_VOC_yolov5s_0.753{sep}2, runs/run-20230924_162645-c9elreke_VOC_yolov5s_0.753{sep}3, ... etc.
